...
<head>
    ...
    <head>
        ...
        <title>WAFFLE CITY | Gallary</title>
...
<body>
    ...
    <div class="container-fluid py-4">
        <div class="wrapper-container" data-aos="fade-up" data-aos-duration="1000">
            <p style="font-size: 22px;">Gallary</p>
            <div class="">
                <div class="row gallary-container mx-auto">
                    <?php
                    $sql= "SELECT * FROM gallary";
                    $stmt= $db->query($sql);
                    while ($galleryRow= $stmt->fetch()) {
                        
                    
                    ?>
                    <div class="col-lg-4 col-md-6 col-sm-12 p-0">
                        <img src="assets/img/gallary/<?php echo $galleryRow['img']?>" class="img-fluid" alt="">
                    </div>
                    <?php } ?>
                </div>
            </div>
